		...
		if(isset($_POST['Address'])AND($_POST['Address'])!=NULL)
		{
			...
			if (preg_match('/^[0-9]*$/', $_POST['Adharno']))
									            ...
									            if(isset($_POST['Email'])AND($_POST['Email'])!=NULL)
								{
				                            ...
				                            $obj->pension_profile_edit($key,$Name,$Address,$Pincode,$District,$Gender,$Depo,$DOB,$Retirementdate,$Contactno,$Email);
								}
								else
									...
									echo"<script>alert('Phone Number is empty')</script>";
												...
												echo "<script> alert('Aadharnumber should be 12 digit!')</script>";	
										}
										else
											echo "<script> alert('Please enter numbers for Aadharnumber!')</script>";	
									}
							else
								echo"<script>alert('Aadhar Number is empty')</script>";
							}
								else
...
$smartyObj->display('pension_profile.tpl');
