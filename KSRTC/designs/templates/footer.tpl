...
<div class="row">
<div class="col-12">
<p class="text-custom-white">© KSRTC ALL RIGHTS RESERVED. <a href="#" class="text-custom-white"></a></p>
</div>
</div>
</div>
</div>
