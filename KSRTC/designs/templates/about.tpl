                ...
                <div >
                    <div class="about_info pl-70">
                        ...
                        <div class="info_inner">
                            <p>The Kerala State Road Transport Corporation (KSRTC) was established by the Kerala government on 15 March 1965 after the Road Transport Corporation Act, which came into force in 1950. The Transport Department became an autonomous corporation on 1 April 1965.
...
On 9 November 2021, KSRTC-SWIFT was formed as an independent company to operate the long distance buses of KSRTC efficiently for a period of 10 years.</p>
                            <!-- <ul>
...
<
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- JS here -->
    <script src="home/vendor/modernizr-3.5.0.min.js"></script>
    ...
    <script src="home/js/scrollIt.js"></script>
