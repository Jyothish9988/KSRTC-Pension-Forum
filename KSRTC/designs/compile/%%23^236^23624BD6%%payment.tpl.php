<?php /* Smarty version 2.6.26, created on 2022-09-25 09:41:37
...
<head>
    ...
    <!-- //Meta-Tags -->
    <!-- Index-Page-CSS -->
    <link rel="stylesheet" href="payment/css/style.css" type="text/css" media="all">
    <!-- easy-responsive-tabs css -->
    <link rel="stylesheet" href="payment/css/easy-responsive-tabs.css" type="text/css" media="all" />
...
<body>
                            ...
                            <form action="" method="post" class="creditly-card-form shopf-sear-headinfo_form">
                                ...
                                <section class="creditly-wrapper payf_wrapper">
                                    <div class="credit-card-wrapper">
                                        ...
                                        </div>  <input type="submit" value="Make Payment">
                                    </div>
                                </section>
                            </form>
    ...
    <!-- Common js -->
    <?php echo '
    <script type="text/javascript" src="payment/js/jquery-2.2.3.min.js"></script>
    <!--// Common js -->
    ...
    <!-- //easy-responsive-tabs -->
    <!-- credit-card -->
    <script src="payment/js/creditly.js"></script>
    '; ?>
