<?php /* Smarty version 2.6.26, created on 2022-05-20 12:30:01
         compiled from news_sub_header.tpl */ ?>
<!DOCTYPE html>
<html lang="en">

<!-- Mirrored from www.codezion.com/themes/html/toor/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Apr 2022 15:56:15 GMT -->
<head>
...
<title>Toor - Travel Booking HTML5 Template | About Us</title>

<link rel="apple-touch-icon-precomposed" sizes="144x144" href="user/assetss/images/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="user/assetss/images/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="user/assetss/images/favicon.ico">
<link rel="apple-touch-icon-precomposed" href="user/assetss/images/favicon.ico">
<link rel="shortcut icon" href="user/assetss/images/favicon.ico">
...
<div class="right-side">
 <ul class="custom-flex">
<li>
<a href="#" class="text-custom-white">Login</a>
</li>
<li>
<a href="#" class="text-custom-white">Signup</a>
</li>
<li>
<select>
<option>USD</option>
...
<h3><a href="#" class="text-light-dark">Home</a></h3>
...
<h3><a href="#" class="text-light-dark">Hotels</a></h3>
<ul class="custom sub-menu">
<li class="menu-item menu-item-has-children">
...
&nbsp; &nbsp;
<li class="menu-item menu-item-has-children">
<h3><a href="#" class="text-light-dark">Flights</a></h3>
<ul class="custom sub-menu">
<li class="menu-item menu-item-has-children">
...
&nbsp; &nbsp;
<li class="menu-item menu-item-has-children">
<h3><a href="#" class="text-light-dark">Cruise</a></h3>
<ul class="custom sub-menu">
<li class="menu-item menu-item-has-children">
...
<a href="cruise-detail.html" class="text-custom-white">Cruise Detail</a>
 ...
 &nbsp; &nbsp;
<li class="menu-item menu-item-has-children">
<h3><a href="#" class="text-light-dark">Cars</a></h3>
<ul class="custom sub-menu">
<li class="menu-item menu-item-has-children">
...
&nbsp; &nbsp;
<li class="menu-item menu-item-has-children">
<h3><a href="#" class="text-light-dark">Blog</a></h3>
<ul class="custom sub-menu">
<li class="menu-item menu-item-has-children">
...
&nbsp; &nbsp;
<li class="menu-item menu-item-has-children">
<h3><a href="#" class="text-light-dark">Pages</a></h3>
<ul class="custom sub-menu">
<li class="menu-item">
...
<li class="menu-item">
<a href="stmr_profile.php" class="text-custom-white">PROFILE</a>
</li>
</ul>
</li>
...
<li class="menu-item">
<a href="news.php" class="text-custom-white">NEWS</a>
</li>
</ul>
</li>
...
<li class="menu-item">
<a href="stmr_pension_panel.php" class="text-custom-white">PENSION APPLICATION</a>
</li>
<!-- <li class="menu-item">
<a href="#" class="text-custom-white">PENSION UPDATE</a>
</li> -->
</ul>
</li>
...
<li class="menu-item">
<a href="stmr_pension_message_view.php" class="text-custom-white">Inbox (<?php echo $this->_tpl_vars['msg']; ?>
)</a>

</li>

<li class="menu-item">
<a href="stmr_msg_stmr_view.php" class="text-custom-white">view sent messages</a>
</li>
</ul>
 </li>
<li class="menu-item menu-item-has-children">
...
<div class="cta-btn">
<a href="#" class="btn-first btn-submit">Coming Soon</a>
</div>
</div>
<div class="hamburger-menu">
<div class="menu-btn">
