<?php /* Smarty version 2.6.26, created on 2022-10-09 12:02:42
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="title" placeholder="Enter News Title..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-email" name="report" placeholder="Enter News Report..">
                                            </div>
                                        </div>
