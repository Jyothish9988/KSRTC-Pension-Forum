<?php /* Smarty version 2.6.26, created on 2022-09-24 06:44:40
         compiled from pension_sub_header.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
...
<li class="menu-item">
<a href="pension_notification.php" class="text-custom-white">NOTIFICATION(<?php echo $this->_tpl_vars['notif']; ?>
)</a>
</li>
...
<ul class="custom sub-menu">
      ...
      <li class="menu-item">
      <a href="pension_message_send.php" class="text-custom-white">Compose message to stationmaster</a>
      </li>
