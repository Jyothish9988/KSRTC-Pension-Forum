<?php /* Smarty version 2.6.26, created on 2022-09-24 06:44:40
         compiled from pension_apply.tpl */ ?>
<html>
<head>
...
?>
                  <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <!-- <tr><td align="right-side"><b>Photo</b></td><td><input type="file" name="Photo" value="<?php echo $this->_tpl_vars['j']['Photo']; ?>
" readonly></td></tr> -->
                        <center>
...
<?php endif; ?>
               ...
               <tr><td><b>Depo</b></td><td><input type="text" name="Depo" value="<?php echo $this->_tpl_vars['j']['Depo']; ?>
" readonly class="form-control" class="form-control"></td></tr>
...
" readonly class="form-control"></td>
      ...
      <tr><td><b>Address</b></td><td><textarea name="Address" readonly class="form-control"><?php echo $this->_tpl_vars['j']['Address']; ?>
</textarea></tr>
...
<tr><td><b>Contact Number</b></td><td><input type="number" name="Contactno" placeholder="+91" value="<?php echo $this->_tpl_vars['j']['Contactno']; ?>
" readonly class="form-control"></td></tr>
