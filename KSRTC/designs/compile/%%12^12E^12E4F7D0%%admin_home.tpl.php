<?php /* Smarty version 2.6.26, created on 2022-10-09 13:40:39
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['pension']; ?>
</h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['station']; ?>
</h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['msges']; ?>
</h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
