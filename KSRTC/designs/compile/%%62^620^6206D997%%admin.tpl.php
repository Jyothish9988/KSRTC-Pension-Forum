<?php /* Smarty version 2.6.26, created on 2022-04-25 10:54:44
...
<head>
    ...
    <title>ADMIN</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="admin2/images/favicon.png">
    <!-- Pignose Calender -->
    <link href="admin2/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="admin2/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="admin2/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    ***********************************-->
    ...
    <script src="admin2/js/settings.js"></script>
    <script src="admin2/js/gleek.js"></script>
    <script src="admin2/js/styleSwitcher.js"></script>

    <!-- Chartjs -->
    <script src="admin2/plugins/chart.js/Chart.bundle.min.js"></script>
    <!-- Circle progress -->
    <script src="admin2/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
    <script src="admin2/plugins/d3v3/index.js"></script>
    <script src="admin2/plugins/topojson/topojson.min.js"></script>
    <script src="admin2/plugins/datamaps/datamaps.world.min.js"></script>
    <!-- Morrisjs -->
    <script src="admin2/plugins/raphael/raphael.min.js"></script>
    <script src="admin2/plugins/morris/morris.min.js"></script>
    <!-- Pignose Calender -->
    <script src="admin2/plugins/moment/moment.min.js"></script>
    <script src="admin2/plugins/pg-calendar/js/pignose.calendar.min.js"></script>
    <!-- ChartistJS -->
    <script src="admin2/plugins/chartist/js/chartist.min.js"></script>
    <script src="admin2/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>



    <script src="admin2/js/dashboard/dashboard-1.js"></script>
