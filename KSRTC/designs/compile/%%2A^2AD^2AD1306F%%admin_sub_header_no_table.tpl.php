<?php /* Smarty version 2.6.26, created on 2022-06-11 18:38:22
         compiled from admin_sub_header_no_table.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="stmr_admin_msg_send_view.php">Inbox (<?php echo $this->_tpl_vars['msg']; ?>
)</a></li>
                            <!-- this is viewed and replied by admin to stmr messages -->
                   ...
                   <!--  <li>
                        <a href="admin_news.php" aria-expanded="false">
                    ...
                    <li class="nav-label">Payment</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Payment</span>
                        </a>
                        <ul aria-expanded="false">
