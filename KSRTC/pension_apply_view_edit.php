								...
								if(isset($_POST['qsvcp'])AND($_POST['qsvcp'])!=NULL)
								{
									if(isset($_POST['lbp'])AND($_POST['lbp'])!=NULL)
									{
											...
											if(isset($_POST['pf'])AND($_POST['pf'])!=NULL)
										{
				                            ...
				                            $obj->pension_apply_update($key,$fathername,$mothername,$marital,$nationality,$state,$religion,$category,$qsvcp,$lbp,$da,$pf,$qsvcpy);
...
$smartyObj->display('pension_apply_view_edit.tpl');
